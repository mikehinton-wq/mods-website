...
const packages = [
  { label: 'Single Lesson',   duration: '1 hour',    price: '£40',              highlight: false },
  { label: 'Single Lesson',   duration: '1.5 hours', price: '£60',              highlight: false },
  { label: 'Single Lesson',   duration: '2 hours',   price: '£80',              highlight: false },
        ...
        <div className="container">
          <div style={{ maxWidth: 760, margin: '0 auto' }}>
            ...
            <p style={{ color: 'var(--grey-700)', marginBottom: 24, lineHeight: 1.7 }}>
              Payment is accepted by cash or bank transfer at the end of each lesson. No hidden fees — what you see is what you pay.
            </p>
